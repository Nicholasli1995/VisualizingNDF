...
def parse_arg():
    ...
    # choice of dataset
    parser.add_argument('-dataset', choices=['mnist', 'cifar10', 'Nexperia'], 
                        default='cifar10')
...
#    parser.add_argument('-n_class', type=int, default=10) 
    ...
    # use all images from Nexperia dataset for training
    parser.add_argument('-train_all', type=bool, default=False)    
    # if not, specify the used training fraction for Nexperia dataset
